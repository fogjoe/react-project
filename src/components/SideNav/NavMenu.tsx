...
function NavItem(props: NavItemProps) {
  ...
  return (
    <div className={`flex cursor-pointer flex-col items-center gap-1 rounded-md p-2 ${styles.item}`}>
      {icon}
    ...
    <div>
      <Space direction="vertical" size={14}>
        <NavItem
          ...
          active
          icon={
            <svg aria-hidden="true" className="size-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path clipRule="evenodd" d="M20 10H4v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8ZM9 13v-1h6v1c0 .6-.4 1-1 1h-4a1 1 0 0 1-1-1Z" fillRule="evenodd" />
        ...
        <Link href="https://github.com/fogjoe/react-project" target="_blank">
          <NavItem
            icon={
              <svg aria-hidden="true" className="size-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
